...
const phases: Phase[] = [
  {
    ...
    items: [
      ...
      {
        label: "Private debtor payment (create_payment_request → pay_invoice)",
        done: true,
      },
      { label: "Factor marketplace (discovery and browsing)", done: true },
      { label: "Settlement (settle_invoice)", done: true },
      {
        label: "Basic web UI for business, factor, and debtor roles",
        done: true,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label:
          "API integration for accounting software (QuickBooks, Xero, Sage)",
        done: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Factor partnerships (onboard 5–10 progressive factors)",
        done: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Cross-border factoring with multi-currency support",
        done: false,
      },
      { label: "White-label licensing for banks and fintechs", done: false },
      {
        label: "Compliance framework (KYC/AML integration points)",
        done: false,
      },
  ...
  },
  {
    ...
    items: [
      {
        label:
          "Supply chain integration (auto-generate invoices from delivery)",
        done: false,
      },
    ...
    <div className="container py-16 max-w-4xl">
      <div className="text-center mb-16">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          From testnet MVP to a global privacy-preserving invoice factoring
          ecosystem.
        </p>
      </div>
                  ...
                  {phase.current && (
                    <div className="mt-4 pt-4 border-t border-border">
                      <p className="text-xs text-muted-foreground">
                        {phase.items.filter((i) => i.done).length} of{" "}
                        {phase.items.length} items complete
                      </p>
                    </div>
                  )}
                </CardContent>
