      ...
      <div className="mb-10">
        ...
        <Section title="2. Testnet Status and No Real Value">
          <p>
            ...
            . Testnet tokens have no monetary value. No fiat currency,
            stablecoins, or real-world assets are transferred through the
            Platform at this time.
          </p>
          <p>
            All transactions, invoices, and factoring operations performed on
            the Platform are for demonstration and testing purposes. Do not
            treat any output of the Platform as legally binding financial
            transactions.
          </p>
        </Section>
        ...
        <Section title="3. Not Financial Advice">
          ...
          <p>
            Consult qualified financial and legal professionals before making
            any real financial decisions related to invoice factoring or
        ...
        <Section title="4. No Warranties">
          <p>
            ...
            the Platform will be uninterrupted, error-free, or free of security
            vulnerabilities.
          </p>
          <p>
        ...
        <Section title="5. Limitation of Liability">
          <p>
            To the maximum extent permitted by law, ZK Factor and its
        ...
        <Section title="6. Third-Party Services">
          <p>
            The Platform integrates with third-party services that have their
          ...
          <p>
            We are not responsible for the availability, security, or practices
            of these services. Documents uploaded to IPFS are content-addressed
            and may be permanently available on the public IPFS network. Do not
            upload confidential documents unless you understand the
            implications.
          </p>
        </Section>
        ...
        <Section title="7. Privacy & Data">
          <p>
            ...
            owners. Public mappings and serial numbers are visible to all
        ...
        <Section title="8. User Responsibilities">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>
              Securing your wallet private keys — we have no access to them
            </li>
        ...
        <Section title="9. Intellectual Property">
          <p>
            The ZK Factor platform is open-source software. Smart contract code
            is available for review on the Aleo blockchain. Frontend source code
            may be made available under an open-source license.
          </p>
          <p>
            Nothing in these terms grants you ownership of ZK Factor trademarks
            or branding.
          </p>
        </Section>
