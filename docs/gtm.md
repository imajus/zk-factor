...
- **Protocol fee**: 0.1-0.5% of factored amount (competitive with [industry fees of 0.55% to 8.25%](https://www.ibisworld.com/united-states/market-research-reports/invoice-discounting-industry/))
...
1. **Validate Market**: Interview 20+ SMEs (targeting the [91% with cash flow issues](https://www.prnewswire.com/news-releases/new-relay-cash-flow-compass-uncovers-small-businesses-are-42-overconfident-in-their-cash-flow-control-302222383.html) but not using factoring) and 10+ factors (from the [50%+ who experienced fraud](https://magazine.factoring.org/magazine-articles/the-hidden-risks-of-fraud-in-factoring-and-invoice-discounting)) to validate pain points
2. **Build MVP**: Focus on core fraud prevention value prop (Q1 2026)
3. **Secure Early Partners**: 3-5 progressive factors committed to pilot (targeting non-bank fintechs disrupting the [64-80% bank-dominated market](https://www.gminsights.com/industry-analysis/factoring-services-market))
4. **Educational Content**: Create explainer materials for non-technical audience emphasizing privacy advantages over [existing blockchain solutions](https://www.gtreview.com/news/asia/invoice-finance-platform-adopts-blockchain-tool-to-stop-fraud-and-double-financing/)
5. **Community Engagement**: Build presence in Aleo and fintech communities, highlighting relevance to [$5.7T SME financing gap](https://www.smefinanceforum.org/data-sites/msme-finance-gap)
