...
- **Shield Wallet** browser extension — download from [shield.app](https://www.shield.app/)
- Some testnet ALEO tokens for transaction fees
...
| Role | Who is it for? |
|---|---|
| **Business** | Companies that want to sell invoices for immediate cash |
| **Factor** | Financial institutions that buy invoices at a discount |
...
- **Businesses**: [Create your first invoice](business/create-invoice.md)
- **Factors**: [Register as a factor](factor/register.md)
